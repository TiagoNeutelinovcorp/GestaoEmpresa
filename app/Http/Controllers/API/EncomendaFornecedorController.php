...
class EncomendaFornecedorController extends Controller
{
    ...
    public function index()
    {
        return response()->json(
            DB::table('encomendas_fornecedores')
                ...
                ->where('encomendas_fornecedores.tenant_id', $this->tenantId())
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(
            DB::table('encomendas_fornecedores')->where('tenant_id', $this->tenantId())->where('id', $id)->first(),
            201
        );
    }
    ...
    public function pdf(int $id)
    {
        ...
        $linhas = DB::table('encomenda_fornecedor_linhas')
            ...
            ->where('encomenda_fornecedor_linhas.tenant_id', $this->tenantId())
